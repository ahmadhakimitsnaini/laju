    ...
    >
      ...
      <div className="relative max-w-6xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-8 mb-12">
          ...
          {/* Right: Creator Card */}
          <div className="p-6 rounded-3xl glass-card min-w-72 cursor-default">
            <p className="text-xs text-gray-400 uppercase font-bold tracking-widest mb-3">
              Case Study by
            </p>
            <p className="text-gray-900 font-bold text-lg mb-0.5">
